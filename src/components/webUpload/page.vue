<template>
    <div class="page">
		...
		<el-button type="primary" id="filePicker" size="small ">选择文件<div id="filePicker"></div></el-button>
            ...
            <div class="file-list">
                <ul class="file-item" :class="`file-${file.id}`" v-for="file in fileList">
                    ...
                    <li class="file-operate">
                        <a title="开始" @click="resume(file)">开始<i class="iconfont icon-control-play"></i></a>
                        <a title="暂停" @click="stop(file)">暂停<i class="iconfont icon-video-pause"></i></a>
                        <a title="移除" @click="remove(file)">移除<i class="iconfont icon-close-big"></i></a>
                    </li>
