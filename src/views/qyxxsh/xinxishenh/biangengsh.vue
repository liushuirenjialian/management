		...
		<el-row :gutter="100">
			<el-form :model="ruleForm2" status-icon :rules="ruleForm2" ref="ruleForm2" label-width="140px" class="demo-ruleForm">
				<el-col :span="12">
					...
					<el-form-item label="法人证件类型：" prop="cardType">
						<el-select v-model="ruleForm2.cardType" placeholder="请选择" disabled>
							<el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
							</el-option>
						</el-select>
					</el-form-item>
					<el-form-item label="法人证件号码：" prop="cardTypeValue">
						...
						<div v-for="(item,index) in ruleForm2.files">
							<label >
								<span style="width: calc(100% - 88px);display:inline-block;overflow:hidden;
    text-overflow:ellipsis;    white-space:nowrap">{{item.originalName}}</span>
							</label>
							<label>
				...
				<el-col :span="12">
					...
					<el-form-item label="业务勾选：">
						<el-checkbox-group v-model="ruleForm2.menus">
				...
				<el-col :span="24" style="text-align: center;">
					...
					<el-button type="primary" @click="adopt(3)">返回</el-button>
